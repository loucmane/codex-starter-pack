...
- **2026-05-25 14:28** — [S:20260525|W:task122-aegis-workflow-guidance-adapter-portability|H:codex:live-test|E:/tmp/aegis-task122-live-test-uCJKG0/shop-webapp] Fresh Claude live testing found that MCP `aegis.closeout_ready` created a pending tracking event even though it is a read-only pre-closeout inspection.
- **2026-05-25 14:28** — [S:20260525|W:task122-aegis-workflow-guidance-adapter-portability|H:codex:implement|E:.claude/scripts/gate_lib.py] Fixed source and packaged Claude hooks to classify Aegis read-only MCP tools explicitly while leaving unknown external MCP tools conservative.
- **2026-05-25 14:28** — [S:20260525|W:task122-aegis-workflow-guidance-adapter-portability|H:codex:verify|E:cmd`PYTHONDONTWRITEBYTECODE=1 ./.venv/bin/python -m pytest tests/meta_workflow_guard/test_aegis_*.py`] Re-ran the full Aegis meta-workflow suite after the live-test fix with 152 passed and 4 opt-in smoke tests skipped.
- **2026-05-25 15:03** — [S:20260525|W:task122-aegis-workflow-guidance-adapter-portability|H:codex:live-retest|E:/tmp/aegis-task122-live-retest-20260525-1428/shop-webapp] Fresh Claude retest passed end to end; `aegis.closeout_ready` remained read-only and did not create pending tracking.
