...
- 2026-07-13 — Recover Taskmaster only through supported transitions: preserve the failed
  serialization attempt in local forward history, revert it normally, recreate Task 248
  from a clean Task-247 authority worktree, run guided kickoff, and cherry-pick the clean
  kickoff commit. Do not hand-edit `tasks.json` or use prohibited worktree restoration.
