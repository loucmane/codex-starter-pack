...
- 2026-05-25 — [S:20260525|W:task123-aegis-release-candidate-global-mcp-proof|H:codex:implement|E:scripts/_aegis_installer.py] Existing `CLAUDE.md` files are not conflicts by default. Aegis must insert or update a delimited runtime block while preserving the project's original Claude instructions below it.
