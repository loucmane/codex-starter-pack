...
- 2026-06-04 — External review found a remaining value-lock blind spot in the state.json contract: guards that only compared both-present values allowed active-tag inject/clear/remove and branch mapping removal. The follow-up patch treats those presence transitions as semantic mutations.
