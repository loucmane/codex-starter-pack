...
- 2026-08-31 — Restricted process visibility must remain `unknown`; it cannot be collapsed into process absence.
- 2026-09-01 — A completed reconciler cycle confirmed every registered project and the continuity dashboard through host Obsidian IPC while the existing app scope remained unchanged.
