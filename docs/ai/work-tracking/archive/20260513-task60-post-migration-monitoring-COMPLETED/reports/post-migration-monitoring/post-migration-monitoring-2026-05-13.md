...
- Label: task-60-post-migration-monitoring
- Created at: 2026-05-13T14:29:41+02:00
...
| --- | --- | --- | --- | --- | --- |
| migration_metrics | docs/ai/work-tracking/archive/20260513-task55-migration-metrics-collection-COMPLETED/reports/migration-metrics-collection/migration-metrics-2026-05-13.json | True | fail | error | 2026-05-13T13:38:11+02:00 |
| migration_health | docs/ai/work-tracking/active/20260513-task60-post-migration-monitoring-ACTIVE/reports/post-migration-monitoring/source-migration-health/latest.json | True | warn | warning | 2026-05-13T14:28:13.316741+02:00 |

## Required Actions

- **error** - Resolve or explicitly waive failing migration KPIs. `Review the migration metrics runbook and update the roadmap before closing monitoring.`
- **warning** - Review warning or missing migration-health components. `python3 scripts/codex-task report generate --kind telemetry`
...
| Broken references | fail | error | 43 | 0 | scripts/template-ssot-scanner/output/data/baseline_summary.json |
| Circular dependencies | fail | error | 19 | 0 | scripts/template-ssot-scanner/output/data/baseline_summary.json |
| Duplicate files | warn | warning | 4 | 0 | scripts/template-ssot-scanner/output/data/baseline_summary.json |
| Recommended fixes | warn | warning | 45 | 0 | scripts/template-ssot-scanner/output/data/baseline_summary.json |
| Security findings | pass | info | 0 | 0 | scripts/template-ssot-scanner/output/data/security_validation.json |
| Critical roadmap items | fail | error | 24 | 0 | docs/ai/work-tracking/active/20260513-task55-migration-metrics-collection-ACTIVE/reports/migration-metrics-collection/migration-roadmap-2026-05-13.json |
| Total roadmap items | warn | warning | 51 | reviewed backlog | docs/ai/work-tracking/active/20260513-task55-migration-metrics-collection-ACTIVE/reports/migration-metrics-collection/migration-roadmap-2026-05-13.json |

### Migration Health

| Item | Status | Severity | Value | Target | Evidence |
| --- | --- | --- | --- | --- | --- |
| Template metrics dashboard | pass | info |  |  | reports/template-metrics/latest.json |
| Template monitoring report | missing | warning |  |  | reports/template-monitoring/latest.json |
| Phase 0 scanner validation report | missing | warning |  |  | reports/phase0-scanner-validation/latest.json |
| Template performance report | pass | info |  |  | reports/template-performance/latest.json |
| Cost tracking report | missing | warning |  |  | reports/cost-tracking/latest.json |
