...
- 2026-05-17 — Work-tracking contract-document tests must not depend exclusively on ACTIVE folders. For completed task evidence, tests should prefer the archived `*-COMPLETED` path and only fall back to ACTIVE while the source task is still open.
