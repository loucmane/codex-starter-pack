...
- [ ] Implement only the proven current-state audit/reporting or remediation-tracking gap with focused evidence
- [ ] Keep security audit behavior deterministic, repo-local, and non-destructive unless current evidence proves runtime integration is required
