...
| plan-step-profile | Add the digest-bound project-owned HPFetcher profile and bundle builders without changing domain verdict logic | docs/ai/work-tracking/active/20260830-ga-k0ry-evidence-workflow-v1-ACTIVE/designs/evidence-workflow-v1-contract.md; bead:ga-k0ry | pending |
| plan-step-pilot | Run one authorized report-only frozen shadow pilot with seal/dispatch/release ordering, Fable readback, zero residue, and authoritative-output parity | bead:ga-k0ry; evidence-run:pending | pending |
