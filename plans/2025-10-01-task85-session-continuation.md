...
| plan-step-implement | Build workflows/handlers, update registry + guard, add regression  | docs/ai/work-tracking/active/20251001-task85-session-continuation-ACTIVE/designs/continuation-workflow-updates.md, templates/workflows/session/continuation.md, templates/workflows/session/state-management.md | in_progress |
