...
- Outstanding risks/todos: publish the signed exact head, require hosted workflows to
  pass, reconcile repository settings without weakening branch protection, and retain
  legacy Taskmaster only as conditional compatibility evidence.
