...
|---------------------|----------------------------------------------------------------------|------------------------------------------------------------|---------|
| plan-step-scope     | Define Taskmaster alignment prerequisites and impacted artifacts     | Session log + tracker entries + docs/ai/work-tracking/archive/20251021-task88-taskmaster-alignment-COMPLETED/designs/alignment-scope.md | completed |
...
| plan-step-verify    | Alignment workflow documented, guard/tests recorded, Taskmaster notes | reports/taskmaster-alignment/guard-2025-10-25-pass.txt; reports/taskmaster-alignment/tests-2025-10-25-guard.txt; docs/ai/work-tracking/archive/20251021-task88-taskmaster-alignment-COMPLETED/TRACKER.md | completed |
