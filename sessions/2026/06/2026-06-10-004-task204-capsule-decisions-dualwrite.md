...
- **[19:44]** — [S:20260610|W:task204-capsule-decisions-dualwrite|H:claude:Edit|E:.claude/scripts/gate_lib.py] Implemented gate-decisions dual-write (Payload session attribution, best-effort ledger twin keyed on payload_digest) plus the WAL-pragma race fix in ledger_lib found by the suite under real recorder concurrency
