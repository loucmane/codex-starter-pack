...
- **[17:55]** — [S:20260826|W:ga-k9sd-beads-first-guidance|H:windows-bootstrap:powershell51|E:scripts/windows/gas-city-wsl-bootstrap.ps1] Diagnosed and repaired the scheduled-task smoke failure: Windows PowerShell 5.1 did not provide nested wsl.exe LASTEXITCODE and lacks ConvertFrom-Json -Depth; process-object capture now produces durable pass/fail evidence.
- **[18:08]** — [S:20260826|W:ga-k9sd-beads-first-guidance|H:windows-bootstrap:shared-custody|E:scripts/windows/install-gas-city-wsl-bootstrap.ps1] Scheduled-token diagnostics proved Codex Desktop LocalAppData virtualization: the same SID saw the app-written bootstrap as absent, while a USERPROFILE marker was visible from both contexts. Moved bootstrap and evidence to shared USERPROFILE custody.
