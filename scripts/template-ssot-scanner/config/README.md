...
- `integration.py` - dependency-injection context that resolves config once and injects ConfigLoader, RuleEngine, PatternMatcher, and file-discovery settings into scanner modules.
