...
- `aegis_foundation/reconcile_shadow_apply.py`
  ...
  - Follow-up hardening after external review refuses active-tag inject/clear/remove and
    branch mapping removal, closing the state.json presence-transition asymmetry.
...
- `.github/workflows/ci.yml`
  ...
  - Runs the accumulation step with `PYTHONDONTWRITEBYTECODE=1`.
