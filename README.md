...
Aegis Foundation is a portable multi-agent workflow foundation with runtime gates, Taskmaster-aware work tracking, and an installer/MCP surface for adopting the system into other projects.
